    ...
    <>
      <div className="relative flex items-center justify-between py-5 bg-foreground shadow-md">
        <div className="flex flex-row items-center mx-5 md:mx-10 lg:mx-20 w-full">
          <svg className="w-6 md:w-7 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <ul className="flex-row md:gap-5 lg:gap-7 mx-5 md:mx-10 lg:mx-20 hidden md:flex">
          {shortCut.map((item, index) => (
            <li key={index} className={`${activeSection === item.name.toLowerCase() ? "text-text-secondary bg-background" : "text-text-primary"} gap-2 px-4 py-3 rounded-md flex flex-row items-center hover:scale-105 hover:bg-[#1f3140] active:scale-105 active:bg-[#1f3140] transition-transform duration-200 ease-in-out`}>
              {item.d}
...
const shortCut = [
  {
    name: "Home",
    d: (
      <svg className="w-4 md:w-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  ...
  },
  {
    name: "Projects",
    d: (
      <svg className="w-4 md:w-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
