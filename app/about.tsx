...
export default function About() {
  ...
  return (
    <>
      <section id="about" className="cursor-default bg-thirdary">
        <FadeDown>
          <h2 className="text-2xl md:text-4xl font-bold text-text-primary text-center mb-5 md:mb-10 pt-5 md:pt-10">About Me</h2>
        </FadeDown>
        ...
        <Fade>
          <div className="mt-10 md:mt-20 pb-5 md:pb-10">
            <ScrollVelocity texts={["Hello I'm RyHar", "Fullstack Web Developer"]} velocity={velocity} className="custom-scroll-text text-text-secondary" />
          </div>
        </Fade>
      </section>
    </>
