    ...
    <>
      <section id="home" className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-5 md:px-10 lg:px-20 py-20">
        <div className="flex flex-col gap-3">
          ...
          <span className="text-text-secondary flex flex-row">
            ...
            <div className="flex flex-row gap-4">
              <a href="https://www.instagram.com/rizki_hr4" target="_blank" rel="noopener noreferrer" className="bg-foreground p-2 rounded-full active:shadow-lg active:scale-105 hover:shadow:lg hover:scale-105 text-text-primary transition-transform duration-200 ease-in-out">
              ...
              <a href="https://www.linkedin.com/in/rizkihartawan/" target="_blank" rel="noopener noreferrer" className="bg-foreground p-2 rounded-full active:shadow-lg active:scale-105 hover:shadow:lg hover:scale-105 text-text-primary transition-transform duration-200 ease-in-out">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                </svg>
              </a>
              <a href="https://github.com/RyHarJr" target="_blank" rel="noopener noreferrer" className="bg-foreground p-2 rounded-full active:shadow-lg active:scale-105 hover:shadow:lg hover:scale-105 text-text-primary transition-transform duration-200 ease-in-out">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mb-10 md:mb-0 font-semibold">
            ...
            <ul className="text-text-primary mt-2 flex flex-row gap-2 md:gap-5">
              <li className="items-center flex flex-col md:flex-row shadow-md hover:shadow-lg active:shadow-lg active:scale-105 hover:scale-105 text-xs md:text-sm style-none text-center bg-foreground p-3 rounded-full">
                <svg className="w-5 md:w-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="md:ml-auto flex flex-col items-center justify-center">
          <Image src="/images/hero.jpg" alt="Hero Image" width={350} height={350} className="border-4 border-text-thirdary rounded-full neon floating" />
        </div>
      </section>
    </>
  )
